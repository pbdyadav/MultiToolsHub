...
export function ChangeBackground() {
  ...
  const onFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    img.onload = () => {
      ...
      // Fill background color then draw image on top
  ...
  const download = () => {
    ...
    a.href = resultUrl;
    a.download = 'changed-background.png';
    a.click();
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Change Background</h1>
        <p className="text-gray-600">Demo: fill a solid color under your image. For segmentation, integrate an API.</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <button onClick={process} disabled={!file} className="px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 disabled:opacity-50">Process</button>
            {resultUrl && (
              <div className="mt-4">
